...
func main() {
	...
	flag.StringVar(&saveAndExitOutputArg, "output-gen", "", "Output file to save the results of permutation generated")
	...
	if saveAndExitArg {
		var output string
		if saveAndExitOutputArg != "" {
			output = saveAndExitOutputArg
		} else {
